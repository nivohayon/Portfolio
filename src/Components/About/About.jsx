...
function About() {
    ...
    return (
      ...
      {name && (
        <h1>
          Hi, I am <span className='aboutName'>{name}.</span>
        </h1>
      )}
      ...
      <div className='aboutContact center'>
        {resume && (
          <a href={resume} target="_blank" rel="noreferrer">
            <span type='button' title="Download Resume" className='resumebtn resumebtn--outline'>
              Resume <i style={{backgroundColor:"transparent", color: "currentColor"}} className="bi bi-file-earmark-arrow-down"></i>
            </span>
          </a>
        )}

        {social && (
          <div id="social" title="GitHub">
            {social.github && (
              <a
                href={social.github}
                aria-label='github'
